#include "KartGameKartCar.h"

AKartGameKartCar::AKartGameKartCar()
{
...
// 
// 	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UKartGameSportsWheelFront::StaticClass();
...
// 
// 	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UKartGameSportsWheelFront::StaticClass();
...
// 
// 	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UKartGameSportsWheelRear::StaticClass();
...
// 
// 	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UKartGameSportsWheelRear::StaticClass();
