...
#include "KartGamePlayerController.generated.h"

class UInputMappingContext;
class AKartGamePawn;
class AKartGameKartPawn;
class UKartGameUI;
 ...
 */
UCLASS(abstract)
class AKartGamePlayerController : public APlayerController
{
	GENERATED_BODY()
...
protected:
	...
	TSubclassOf<AKartGameKartPawn> VehiclePawnClass;

	/** Pointer to the controlled vehicle pawn */
	TObjectPtr<AKartGameKartPawn> VehiclePawn;

	/** Type of the UI to spawn */
	UPROPERTY(EditAnywhere, Category="Vehicle|UI")
	TSubclassOf<UKartGameUI> VehicleUIClass;

	/** Pointer to the UI widget */
	TObjectPtr<UKartGameUI> VehicleUI;
