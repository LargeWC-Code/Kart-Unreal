...
void UVoxelEditorEditTool::Setup()
{
	...
	Properties = NewObject<UVoxelEditorEditToolProperties>(this, "Measurement");
...
FInputRayHit UVoxelEditorEditTool::FindRayHit(const FRay& WorldRay, FVector& HitPos)
{
...
void UVoxelEditorEditTool::UpdatePosition(const FRay& WorldRay)
{
...
void UVoxelEditorEditTool::UpdateDistance()
{
